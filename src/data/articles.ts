...
export const articles: Article[] = [
  {
    ...
    date: '2026-07-01',
    readTime: '6 min',
    content: '服务重启失败时，先不要急着反复 restart。更稳的路径是查看 systemd 状态、读取 journalctl 日志，再确认端口由哪个进程监听。\n\n浏览器访问页面不会占用 Prometheus 的监听端口，真正的问题通常来自旧进程残留或服务管理混乱。',
  },
  {
    ...
    date: '2026-07-03',
    readTime: '7 min',
    content: 'Docker CLI 只是入口，dockerd 负责管理上层体验，containerd 则处理更底层的容器生命周期。\n\n排查磁盘占用时需要同时看镜像层、容器数据、快照目录和命名空间。',
  },
  {
    ...
    date: '2026-07-05',
    readTime: '5 min',
    content: '硬链接指向同一个 inode，软链接保存的是路径。\n\n理解这点后，删除源文件、跨文件系统和目录链接这些行为就不再靠死记。',
  },
  {
    ...
    date: '2026-07-08',
    readTime: '8 min',
    content: '多头注意力让模型从不同的子空间观察 token 之间的关系。\n\n它不是简单重复，而是把表示拆成多个视角，再合并成更丰富的上下文表达。',
  },
  {
